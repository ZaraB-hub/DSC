...
public class Ass1_6_1Test {
    ...
    @Test
    @GitHubClassroomGrading(maxScore = 15)
    public void testGetLeastPopularVehicleClassPerArea_Success() {
        ...
        List<TupleResult<String, String>> results = riderPreferenceDAO.getLeastPopularVehicleClassPerArea();

        assertEquals(2, results.size());

        assertEquals("Downtown", results.get(0).getFirst());
        assertEquals("Sedan", results.get(0).getSecond()); // Least popular in Downtown

        assertEquals("Suburbs", results.get(1).getFirst());
        assertEquals("Sedan", results.get(1).getSecond()); // Tie with Van -> lexicographically smallest wins
    }

    @Test
    @GitHubClassroomGrading(maxScore = 10)
    public void testGetLeastPopularVehicleClassPerArea_NoPreferences() {
        List<TupleResult<String, String>> results = riderPreferenceDAO.getLeastPopularVehicleClassPerArea();
    ...
    @Test
    @GitHubClassroomGrading(maxScore = 10)
    public void testGetLeastPopularVehicleClassPerArea_SinglePreference() {
