...
public class TestData implements ITestData {
    ...
    public static final String LOCATION_6_NAME = "location6";
    ...
    public static final Long LOCATION_6_ID = 6L;
    ...
    public void insert(IModelFactory modelFactory, EntityManager em) {
        ...
        ILocation location6 = modelFactory.createLocation();
        ...
        location6.setName(LOCATION_6_NAME);
        ...
        location6.setLocationId(LOCATION_6_ID);
