...
public class ObjectContainerGradingTest {
   ...
   // @Ignore("check thread safety of singleton management")
    ...
    public void getObject_isThreadSafeTowardsCreatingSingletons() throws Exception {
        SingletonComponent a = container.getObject(SingletonComponent.class);
        SingletonComponent b = container.getObject(SingletonComponent.class);
        assertSame(a, b);
    }
    ...
    public void check_CustomTestsImplemented() throws Exception {
        PrototypeComponent a = container.getObject(PrototypeComponent.class);
        PrototypeComponent b = container.getObject(PrototypeComponent.class);
        assertNotSame(a, b);
    }
