...
public class InitializeTest {
    ...
    @Component
    public static class ComponentWithInvalidInitializeSignature {

        @Initialize
        public void myInitMethod(String value) {
        }
    }

    @Test(expected = InvalidDeclarationException.class, timeout = 2000)
    @GitHubClassroomGrading(maxScore = 2)
    public void getObject_rejectsInitializeMethodsWithParameters() {
        container.getObject(ComponentWithInvalidInitializeSignature.class);
    }

    @Component
    public static class ComponentWithFailingInitializeMethod {
    ...
    @GitHubClassroomGrading(maxScore = 2)
    public void getObject_wrapsInitializeMethodFailures() {
        container.getObject(ComponentWithFailingInitializeMethod.class);
    }
